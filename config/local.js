...
module.exports = {
  mailgun: {
    ...
    id: 1,
    name: 'Name Default',
    address: 'default@vuminhdao.info',
    description: "This is description default",
    access_level: 'everyone',
    from: 'info@vuminhdao.info',
    to: 'aleximong@gmail.com',
    subject: 'This is subject',
    text: 'This is content text',
    html: '<h2> This is content html</h2> <a href="http://thietkengay.com"> This is my website, get deals</a>',
    'o:tag': 'Tag Default',
    'o:tracking': 'yes',
    'o:tracking-clicks': 'yes',
    'o:tracking-opens': 'yes',
    'v:my-var': {
      'name': 'variable-nameDefault'
    },
    headers: ["name",  "address", , "age", "mobile"]
  },
